...
class PizzaParlour {
    ...
    public PizzaParlour(String pizzaType, double basePrice) {
        ...
        this.toppingPrice = 0;
        this.toppings = new Vector<String>();
    }
    ...
    public void printReceipt() {
        ...
        System.out.printf("Toppings Cost: $%.2f\n", toppingPrice);
        System.out.printf("Total Cost (Pizza + Toppings): $%.2f\n", calculateTotal());
        System.out.println("-----------------------");
    }
}

public class PizzaParlourClientVec {
    public static void main(String[] args) {
        ...
        while (addingToppings) {
            ...
            if (toppingChoice == -1) {
                ...
                order.addTopping(toppings[toppingChoice], toppingPrices[toppingChoice]);
